<template>
    <div>
        <ul class="nobull">
            <li v-for="item in ploneStore.PortalTypeSubjectListing(props.portal_type, props.tag)" class="" v-if="ploneStore.PortalTypeSubjectListing(props.portal_type, props.tag).length">
        ...
        <div v-if="!ploneStore.PortalTypeSubjectListing(props.portal_type, props.tag).length">
...
<script setup lang="ts">
    ...
    ploneStore.ListingBySubject(props.portal_type, props.tag, props.title);
